...
9. Canales de contacto verificados que puedes compartir: email iazr.code@gmail.com, WhatsApp ${siteConfig.author.whatsappDisplay}, LinkedIn ${siteConfig.author.linkedin} y GitHub ${siteConfig.author.github}. Para tarifas y presupuestos, indica que se acuerdan en una llamada o tras la auditoría inicial — nunca des números inventados.
