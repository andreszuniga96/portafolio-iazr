      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-wrap gap-2 mb-10">
          <button
            ...
            style={{
              background: !activeGroup ? "rgba(255,255,255,0.15)" : "rgba(255,255,255,0.03)",
              border: `1px solid ${!activeGroup ? "rgba(255,255,255,0.4)" : "rgba(255,255,255,0.06)"}`,
              color: !activeGroup ? "#FFFFFF" : "rgba(255,255,255,0.4)",
            }}
          >
            Todo el arsenal
          </button>
